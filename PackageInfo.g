#############################################################################
##  
##  PackageInfo.g for the package `LetterPlace'              Mohamed Barakat
##                                                                  Max Horn
##
...
#
PackageName := "LetterPlace",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "Support for Singular's letter place capabilities",
...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/LetterPlace/LetterPlace-", ~.Version ),
...
#
README_URL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/LetterPlace/README.LetterPlace",
PackageInfoURL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/LetterPlace/PackageInfo.g",
...
#
AbstractHTML := 
"The <span class=\"pkgname\">LetterPlace</span> package provides small dictionaries for \
 <span class=\"pkgname\">homalg</span> to access Singular's letter place capabilities",
#PackageWWWHome := "http://homalg.math.rwth-aachen.de/index.php/extensions/letterplace",
#               
...
PackageDoc := rec(
  # use same as in GAP            
  BookName  := "LetterPlace",
  # format/extension can be one of .zoo, .tar.gz, .tar.bz2, -win.zip
  Archive := 
    "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/LetterPlace/LetterPlace.tar.gz",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "RingsForHomalg", ">= 2011.11.16" ], [ "GAPDoc", ">= 1.0" ] ],
...
#        " (", ~.Persons[3].WWWHome, ")\n",
#  "For help, type: ?LetterPlace package \n",
#  "----------------------------------------------------------------\n" ),
...
TestFile := "examples/RingConstructionsSingular.g.g",

##  *Optional*: Here you can list some keyword related to the topic 
##  of the package.
Keywords := [ "letter place" ]
